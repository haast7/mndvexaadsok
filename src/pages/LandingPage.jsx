            ...
            <div className="max-w-2xl text-center md:text-left relative z-30 w-full md:w-auto">
              ...
              <div className="space-y-6 md:space-y-6">
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight">
                  Aprenda <span className="text-gradient-blue-mobile md:text-transparent md:bg-clip-text md:bg-gradient-to-r md:from-blue-400 md:via-blue-500 md:to-blue-400">como fazer</span>
                  <span className="block mt-2">copiando e colando.</span>
                </h1>
                <p className="text-lg md:text-xl lg:text-2xl text-gray-300 leading-relaxed max-w-xl">
                  Entre no grupo e copie exatamente o que o mentor faz. Sem teoria, sem enrolação. <span className="text-white font-semibold">Só copiar, colar e ganhar.</span>
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                >
                  <span className="flex items-center justify-center gap-3">
                    ...
                    Entrar no grupo e copiar o que o mentor faz
                  </span>
                </a>
