...
const Benefits = () => {
  const benefits = [
    ...
    },
    {
      ...
      description: 'Aprenda a proteger e fazer crescer sua banca de forma sustentável.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Identifique oportunidades reais e evite apostas por impulso.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Momento Certo',
      description: 'Saiba quando aumentar suas apostas e quando é hora de parar.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Comunidade',
      description: 'Conecte-se com outros apostadores comprometidos com a disciplina.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Um método completo que vai além das apostas, desenvolvendo habilidades para a vida
          </p>
        </div>
