...
const NavbarPolicy = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 shadow-lg">
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="md:hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border-t border-gray-700">
